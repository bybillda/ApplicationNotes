...
public class WhatToDoFragment extends Fragment {
    ...
    public static WhatToDoFragment newInstance(String param1, String param2) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (arguments != null) {
            ...
            ImageView imageView = view.findViewById(R.id.what_to_do_strings_view);
            TypedArray images = getResources().obtainTypedArray(R.array.what_to_do_strings);
    ...
    public static WhatToDoFragment newInstance(int index){
        WhatToDoFragment fragment = new WhatToDoFragment();
        Bundle args = new Bundle();
